                        ...
                        <div class="col-md-12">
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-table"></i>Tabel Data Transportasi
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="tabelku">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align: center; vertical-align: middle"> Nama Transportasi </th>
                                                    <th style="width: 20%; text-align: center; vertical-align: middle">
                                                        <button id="tambah" data-target="#tambah_transportasi" data-toggle="modal" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah</button>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    ...
                                    <div id="tambah_transportasi" class="modal fade" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-detail">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <div class="widget-box widget-color-blue2">
                                                        <div class="widget-header">
                                                            <h4 class="widget-title lighter smaller">Tambah Transportasi</h4>
                                                        </div>
                                                        <hr>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <label class="control-label col-md-3">Nama Transportasi</label>
                                                                                <div class="col-md-8">
                                                                                    <input type="hidden" id="mode_form" name="mode_form" value="Tambah"/>
                                                                                    <input type="hidden" id="id_transportasi" name="id_transportasi"/>
                                                                                    <input type="text" id="nama_transportasi" name="nama_transportasi" class="form-control" placeholder="Masukkan Nama Transportasi" autocomplete="off" autofocus/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                ...
                var InitController = function () {
                    var handleValidation = function () {
                        $('#formku').validate({
                            ...
                            submitHandler: function (form) {
                                $.blockUI();
                                $('#tambah_transportasi').modal('hide');
                                $.ajax({
                                    method: 'POST',
                                    dataType: 'json',
                                    url: '<?= site_url() ?>master/do_Simpan_Transportasi',
                    ...
                    var handleTable = function () {
                        ...
                        $('#tabelku').dataTable({
                            ...
                            "sServerMethod": "POST",
                            "bRetrieve": true,
                            "sAjaxSource": "<?= site_url() ?>master/do_Tabel_Transportasi",
                        ...
                        $('body').on('click', '#tabelku_wrapper .btn-editable', function () {
                            ...
                            $.ajax({
                                method: 'POST',
                                dataType: 'json',
                                url: '<?= site_url() ?>master/do_Ubah_Transportasi',
                                data: {'id_transportasi': $(this).attr("data-id")},
                                success: function (data) {
                                    if (data.success === true) {
                                        $.unblockUI();
                                        $('#mode_form').val(data.results.mode_form);
                                        $('#id_transportasi').val(data.results.id_transportasi);
                                        $('#nama_transportasi').val(data.results.nama_transportasi);
                                        $('#tambah_transportasi').modal('show');
                                    } else {
                                        $.unblockUI();
                                        toastr.warning(data.msgServer);
                                    }
                        ...
                        $('body').on('click', '#tabelku_wrapper .btn-removable', function () {
                            ...
                            bootbox.dialog({
                                message: "Apakah anda yakin menghapus </br>Transportasi : <b>" + name + "</b> ?",
                                    ...
                                    success: {
                                        ...
                                        callback: function () {
                                            ...
                                            $.ajax({
                                                method: 'POST',
                                                dataType: 'json',
                                                url: '<?= site_url() ?>master/do_Hapus_Transportasi',
