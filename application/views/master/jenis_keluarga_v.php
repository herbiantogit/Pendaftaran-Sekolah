            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    <div class="page-bar">
                        ...
                        <li>
                    <span>Master Jenis keluarga</span>
                </li>
            </ul>
        </div>
    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-table"></i>Tabel Data Jenis keluarga
                        </div>
                            <div class="tools">
...
<th style="width: 5%; text-align: center; vertical-align: middle"> No </th>
    <th style="text-align: center; vertical-align: middle"> Nama Jenis keluarga </th>
        <th style="width: 20%; text-align: center; vertical-align: middle">
            <button id="tambah" data-target="#tambah_jenis_keluarga" data-toggle="modal" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah</button>
        </th>
    </tr>
</thead>
    <tbody>
                ...
                <div id="tambah_jenis_keluarga" class="modal fade" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-detail">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="widget-box widget-color-blue2">
                                    <div class="widget-header">
                                <h4 class="widget-title lighter smaller">Tambah Jenis keluarga</h4>
                            </div>
                        <hr>
...
<div class="col-md-12">
    <div class="form-group">
        <label class="control-label col-md-3">Nama Jenis keluarga</label>
            <div class="col-md-8">
                <input type="hidden" id="mode_form" name="mode_form" value="Tambah"/>
                <input type="hidden" id="id_jenis_keluarga" name="id_jenis_keluarga"/>
            <input type="text" id="nama_jenis_keluarga" name="nama_jenis_keluarga" class="form-control" placeholder="Masukkan Nama Jenis keluarga" autocomplete="off" autofocus/>
        </div>
</div>
</div>
</div>
...
<script>
    ...
    icon.removeClass("fa-warning");
                            ...
                            submitHandler: function (form) {
                                $.blockUI();
                                $('#tambah_jenis_keluarga').modal('hide');
                                $.ajax({
                                    method: 'POST',
                                    dataType: 'json',
                                    url: '<?= site_url() ?>master/do_Simpan_Jenis_keluarga',
                    ...
                    var handleTable = function () {
                        ...
                        $('#tabelku').dataTable({
                            ...
                            "sServerMethod": "POST",
                            "bRetrieve": true,
                            "sAjaxSource": "<?= site_url() ?>master/do_Tabel_Jenis_keluarga",
                        ...
                        $('body').on('click', '#tabelku_wrapper .btn-editable', function () {
                            ...
                            $.ajax({
                                method: 'POST',
                                dataType: 'json',
                                url: '<?= site_url() ?>master/do_Ubah_Jenis_keluarga',
                                data: {'id_jenis_keluarga': $(this).attr("data-id")},
                                success: function (data) {
                                    if (data.success === true) {
                                        $.unblockUI();
                                        $('#mode_form').val(data.results.mode_form);
                                        $('#id_jenis_keluarga').val(data.results.id_jenis_keluarga);
                                        $('#nama_jenis_keluarga').val(data.results.nama_jenis_keluarga);
                                        $('#tambah_jenis_keluarga').modal('show');
                                    } else {
                                        $.unblockUI();
                                        toastr.warning(data.msgServer);
                                    }
                        ...
                        $('body').on('click', '#tabelku_wrapper .btn-removable', function () {
                            ...
                            bootbox.dialog({
                                message: "Apakah anda yakin menghapus </br>Jenis_keluarga : <b>" + name + "</b> ?",
                                    ...
                                    success: {
                                        ...
                                        callback: function () {
                                            ...
                                            $.ajax({
                                                method: 'POST',
                                                dataType: 'json',
                                                url: '<?= site_url() ?>master/do_Hapus_Jenis_keluarga',
                                                data: {'id_jenis_keluarga': id},
                                                success: function (data) {
                                                    if (data.success === true) {
                                                        $.unblockUI();
                                                        toastr.success(data.msgServer);
