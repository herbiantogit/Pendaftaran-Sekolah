        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <button id="tambah" data-target="#tambah_jeniskelamin" data-toggle="modal" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i>Tambah</button>
                                                    </th>
                                                </tr>
                                            </thead>
                                        <tbody>
                                ...
                                <div id="tambah_jeniskelamin" class="modal fade" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-detail">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <div class="widget-box widget-color-blue2">
                                                        <div class="widget-header">
                                                            <h4 class="widget-title lighter smaller">Tambah Jenis kelamin</h4>
                                                        </div>
                                                        <hr>
                    ...
                    <div class="col-md-8">
                        <input type="hidden" id="mode_form" name="mode_form" value="Tambah"/>
                            <input type="hidden" id="id_jk" name="id_jk"/>
                                <input type="text" id="nama_jeniskelamin" name="nama_jeniskelamin" class="form-control" placeholder="Masukkan Nama Jeniskelamin" autocomplete="off" autofocus/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                ...
                var InitController = function () {
                    var handleValidation = function () {
                        $('#formku').validate({
                            ...
                            submitHandler: function (form) {
                                $.blockUI();
                                $('#tambah_jeniskelamin').modal('hide');
                                $.ajax({
                                    method: 'POST',
                                    dataType: 'json',
                                    url: '<?= site_url() ?>master/do_Simpan_Jeniskelamin',
                    ...
                    var handleTable = function () {
                        ...
                        $('#tabelku').dataTable({
                            ...
                            "sServerMethod": "POST",
                            "bRetrieve": true,
                            "sAjaxSource": "<?= site_url() ?>master/do_Tabel_Jeniskelamin",
                        ...
                        $('body').on('click', '#tabelku_wrapper .btn-editable', function () {
                            ...
                            $.ajax({
                                method: 'POST',
                                dataType: 'json',
                                url: '<?= site_url() ?>master/do_Ubah_Jeniskelamin',
                                data: {'id_jk': $(this).attr("data-id")},
                                success: function (data) {
                                    if (data.success === true) {
                                        $.unblockUI();
                                        $('#mode_form').val(data.results.mode_form);
                                        $('#id_jk').val(data.results.id_jeniskelamin);
                                        $('#nama_jeniskelamin').val(data.results.nama_jeniskelamin);
                                        $('#tambah_jeniskelamin').modal('show');
                                    } else {
                                        $.unblockUI();
                                        toastr.warning(data.msgServer);
                                    }
                        ...
                        $('body').on('click', '#tabelku_wrapper .btn-removable', function () {
                            ...
                            bootbox.dialog({
                                message: "Apakah anda yakin menghapus </br>Jeniskelamin : <b>" + name + "</b> ?",
                                    ...
                                    success: {
                                        ...
                                        callback: function () {
                                            ...
                                            $.ajax({
                                                method: 'POST',
                                                dataType: 'json',
                                                url: '<?= site_url() ?>master/do_Hapus_Jeniskelamin',
                                                data: {'id_jk': id},
                                                success: function (data) {
                                                    if (data.success === true) {
                                                        $.unblockUI();
